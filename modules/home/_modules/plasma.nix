{inputs, ...}: {
  ...
  programs.plasma = {
    ...
    shortcuts = {
      ...
      "khotkeys"."{04df641a-d500-49f7-9aef-d71004a83950}" = "Favorites";
      "khotkeys"."{19fc11ad-125c-4e46-9845-a2237dfc4374}" = "Meta+Return";
      "khotkeys"."{2511aa6e-c2cd-4c39-aed0-d275d531f401}" = "Meta+N";
      "khotkeys"."{d03619b6-9b3c-48cc-9d9c-a2aadb485550}" = [ ];
      "khotkeys"."{f151d3c8-6efc-4489-8359-d586d303879d}" = "Alt+Space";
      ...
      "ksmserver"."Lock Session" = ["Meta+Ctrl+Alt+L" "Screensaver"];
      ...
      "kwin"."PoloniumRetileWindow" = ["Meta+Shift+Space" "Meta+F"];
      ...
      "kwin"."Switch One Desktop to the Left" = ["Meta+Ctrl+H" "Meta+Ctrl+Left"];
      "kwin"."Switch One Desktop to the Right" = ["Meta+Ctrl+Right" "Meta+Ctrl+L"];
      ...
      "kwin"."Window Close" = ["Meta+X" "Alt+F4"];
    ...
    configFile = {
      ...
      "kactivitymanagerdrc"."activities"."b765eb5c-5fc1-468d-82ce-40fbc47b48ab" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "b765eb5c-5fc1-468d-82ce-40fbc47b48ab";
      ...
      "kdeglobals"."General"."BrowserApplication" = "/home/ibrahim.fuad/.local/share/applications/nixGLIntel.desktop";
      ...
      "kdeglobals"."KScreen"."ScreenScaleFactors" = "eDP=1;HDMI-A-0=1;DisplayPort-0=1;DisplayPort-1=1;";
      "kdeglobals"."WM"."activeBackground" = "16,15,15";
      "kdeglobals"."WM"."activeBlend" = "206,205,195";
      "kdeglobals"."WM"."activeForeground" = "206,205,195";
      "kdeglobals"."WM"."inactiveBackground" = "28,27,26";
      "kdeglobals"."WM"."inactiveBlend" = "111,110,105";
      "kdeglobals"."WM"."inactiveForeground" = "135,133,128";
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{94c811dc-cf08-459d-9f44-8788472859a5}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{3f32f5c5-642f-421b-8a95-96970b792ca5}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{c28de3c6-9fe6-4838-91c4-a49654005a29}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{f1b36209-500c-4665-9529-10e6efab9861}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{036b302d-29b6-4ce5-b0bf-17c871094706}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{08f2eb25-7a32-4a16-a04a-ecf366f3fc7b}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{41cdb391-267b-441a-8686-7d981f246980}";
      ...
      "khotkeysrc"."Data_4"."DataCount" = 4;
      "khotkeysrc"."Data_4"."Enabled" = true;
      "khotkeysrc"."Data_4"."Name" = "custom";
      ...
      "khotkeysrc"."Data_4_1"."Name" = "rofi";
      "khotkeysrc"."Data_4_1"."Type" = "SIMPLE_ACTION_DATA";
      "khotkeysrc"."Data_4_1Actions"."ActionsCount" = 1;
      "khotkeysrc"."Data_4_1Actions0"."CommandURL" = "nixGLIntel rofi -show drun";
      ...
      "khotkeysrc"."Data_4_1Triggers0"."Key" = "Alt+Space";
      "khotkeysrc"."Data_4_1Triggers0"."Type" = "SHORTCUT";
      "khotkeysrc"."Data_4_1Triggers0"."Uuid" = "{f151d3c8-6efc-4489-8359-d586d303879d}";
      "khotkeysrc"."Data_4_2"."Comment" = "Comment";
      "khotkeysrc"."Data_4_2"."Enabled" = true;
      "khotkeysrc"."Data_4_2"."Name" = "kitty";
      "khotkeysrc"."Data_4_2"."Type" = "SIMPLE_ACTION_DATA";
      "khotkeysrc"."Data_4_2Actions"."ActionsCount" = 1;
      "khotkeysrc"."Data_4_2Actions0"."CommandURL" = "nixGLIntel kitty";
      ...
      "khotkeysrc"."Data_4_2Triggers0"."Key" = "Meta+Return";
      "khotkeysrc"."Data_4_2Triggers0"."Type" = "SHORTCUT";
      "khotkeysrc"."Data_4_2Triggers0"."Uuid" = "{19fc11ad-125c-4e46-9845-a2237dfc4374}";
      "khotkeysrc"."Data_4_3"."Comment" = "Comment";
      "khotkeysrc"."Data_4_3"."Enabled" = true;
      "khotkeysrc"."Data_4_3"."Name" = "srenty";
      "khotkeysrc"."Data_4_3"."Type" = "SIMPLE_ACTION_DATA";
      "khotkeysrc"."Data_4_3Actions"."ActionsCount" = 1;
      "khotkeysrc"."Data_4_3Actions0"."CommandURL" = "https://www.srenity.online/";
      ...
      "khotkeysrc"."Data_4_3Triggers0"."Key" = "Favorites";
      "khotkeysrc"."Data_4_3Triggers0"."Type" = "SHORTCUT";
      "khotkeysrc"."Data_4_3Triggers0"."Uuid" = "{04df641a-d500-49f7-9aef-d71004a83950}";
      "khotkeysrc"."Data_4_4"."Comment" = "Comment";
      "khotkeysrc"."Data_4_4"."Enabled" = true;
      "khotkeysrc"."Data_4_4"."Name" = "neovide";
      "khotkeysrc"."Data_4_4"."Type" = "SIMPLE_ACTION_DATA";
      "khotkeysrc"."Data_4_4Actions"."ActionsCount" = 1;
      "khotkeysrc"."Data_4_4Actions0"."CommandURL" = "nixGLIntel neovide";
      ...
      "khotkeysrc"."Data_4_4Triggers0"."Key" = "Meta+N";
      "khotkeysrc"."Data_4_4Triggers0"."Type" = "SHORTCUT";
      "khotkeysrc"."Data_4_4Triggers0"."Uuid" = "{2511aa6e-c2cd-4c39-aed0-d275d531f401}";
      ...
      "kscreenlockerrc"."Greeter/Wallpaper/org.kde.image/General"."Image" = "/home/ibrahim.fuad/.local/share/wallpapers/stellarvintage.jpg";
      "kscreenlockerrc"."Greeter/Wallpaper/org.kde.image/General"."PreviewImage" = "/home/ibrahim.fuad/.local/share/wallpapers/stellarvintage.jpg";
      "kwalletrc"."Wallet"."First Use" = false;
      "kwinrc"."Desktops"."Id_1" = "81e8f773-b4bd-4580-88e1-b8d3dfecb125";
      "kwinrc"."Desktops"."Id_2" = "fd135f74-a149-4da6-a605-eb9cecc7675f";
      "kwinrc"."Desktops"."Id_3" = "eddb64cc-83bb-4242-9d71-79bad63b348c";
      ...
      "kwinrc"."NightColor"."LatitudeAuto" = "-33.8715";
      "kwinrc"."NightColor"."LongitudeAuto" = 151.2006;
      "kwinrc"."Plugins"."poloniumEnabled" = false;
      "kwinrc"."Tiling"."padding" = 4;
      "kwinrc"."Tiling/01b2607d-a188-51bd-9ae5-bc0e8dfb7531"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      "kwinrc"."Tiling/4656e9c7-29d2-5198-aef7-e64495a298e9"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[]}";
      ...
      "kwinrc"."Tiling/82f0cf40-94b2-5aa7-aa05-3be9d92a749b"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/a45365d1-53b6-512f-ac6e-a8a018d1f809"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/c9197965-640f-5261-b001-99a442adf0b5"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/dabe49f2-6e76-54a9-af85-4c5f851eae43"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/e4be1829-cea7-5259-bc7d-e8883ff9eda7"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/f29063e9-845d-51da-bc64-8a0336e6c7a2"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"layoutDirection\":\"vertical\",\"tiles\":[{\"height\":0.5,\"layoutDirection\":\"horizontal\",\"tiles\":[{\"layoutDirection\":\"vertical\",\"tiles\":[{\"height\":0.25},{\"height\":0.25}],\"width\":0.25},{\"layoutDirection\":\"vertical\",\"tiles\":[{\"height\":0.25},{\"height\":0.25}],\"width\":0.25}]},{\"height\":0.5,\"layoutDirection\":\"horizontal\",\"tiles\":[{\"layoutDirection\":\"vertical\",\"tiles\":[{\"height\":0.25},{\"height\":0.25}],\"width\":0.25},{\"layoutDirection\":\"vertical\",\"tiles\":[{\"height\":0.25},{\"height\":0.25}],\"width\":0.25}]}],\"width\":0.5},{\"layoutDirection\":\"vertical\",\"tiles\":[{\"height\":0.5,\"layoutDirection\":\"horizontal\",\"tiles\":[{\"layoutDirection\":\"vertical\",\"tiles\":[{\"height\":0.25},{\"height\":0.25}],\"width\":0.25},{\"width\":0.25}]},{\"height\":0.5,\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.25}]}],\"width\":0.5}]}";
      "kwinrc"."Windows"."RollOverDesktops" = true;
      "kwinrulesrc"."04fdbe0a-02bd-4785-aca0-7eba5a8867f3"."Description" = "Application settings for slack";
      "kwinrulesrc"."04fdbe0a-02bd-4785-aca0-7eba5a8867f3"."clientmachine" = "localhost";
      "kwinrulesrc"."04fdbe0a-02bd-4785-aca0-7eba5a8867f3"."shortcut" = "Messenger";
      "kwinrulesrc"."04fdbe0a-02bd-4785-aca0-7eba5a8867f3"."shortcutrule" = 3;
      "kwinrulesrc"."04fdbe0a-02bd-4785-aca0-7eba5a8867f3"."wmclass" = "slack";
      "kwinrulesrc"."04fdbe0a-02bd-4785-aca0-7eba5a8867f3"."wmclassmatch" = 1;
      "kwinrulesrc"."1"."Description" = "Application settings for neovide";
      ...
      "kwinrulesrc"."1"."shortcut" = "Messenger";
      "kwinrulesrc"."1"."wmclass" = "neovide";
      "kwinrulesrc"."1"."wmclassmatch" = 1;
      "kwinrulesrc"."2"."Description" = "Application settings for slack";
      "kwinrulesrc"."2"."clientmachine" = "localhost";
      "kwinrulesrc"."2"."shortcut" = "Messenger";
      "kwinrulesrc"."2"."shortcutrule" = 2;
      "kwinrulesrc"."2"."wmclass" = "slack";
      "kwinrulesrc"."2"."wmclassmatch" = 1;
      "kwinrulesrc"."General"."count" = 2;
      "kwinrulesrc"."General"."rules" = "1,2";
      "kwinrulesrc"."e01b8a5f-32fa-4a8a-85a0-423db5957d0c"."Description" = "Application settings for neovide";
      "kwinrulesrc"."e01b8a5f-32fa-4a8a-85a0-423db5957d0c"."clientmachine" = "localhost";
      "kwinrulesrc"."e01b8a5f-32fa-4a8a-85a0-423db5957d0c"."maximizehoriz" = true;
      "kwinrulesrc"."e01b8a5f-32fa-4a8a-85a0-423db5957d0c"."maximizehorizrule" = 3;
      "kwinrulesrc"."e01b8a5f-32fa-4a8a-85a0-423db5957d0c"."maximizevert" = true;
      "kwinrulesrc"."e01b8a5f-32fa-4a8a-85a0-423db5957d0c"."maximizevertrule" = 3;
      "kwinrulesrc"."e01b8a5f-32fa-4a8a-85a0-423db5957d0c"."wmclass" = "neovide";
      "kwinrulesrc"."e01b8a5f-32fa-4a8a-85a0-423db5957d0c"."wmclassmatch" = 1;
